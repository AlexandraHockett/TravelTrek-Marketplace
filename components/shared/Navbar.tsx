...
const Navbar: React.FC = () => {
  ...
  const getNavLinks = () => {
    ...
    const baseLinks = [
      {
        href: `/${currentLocale}`,
        label: getTranslation("navigation.home", "Início"),
        icon: Home,
      },
    ];
      ...
      case "customer":
        return [
          ...baseLinks,
          {
            ...
            label: getTranslation("navigation.dashboard", "Painel"),
          ...
          {
            href: `/${currentLocale}/customer/bookings`,
            label: getTranslation("navigation.myBookings", "Minhas Reservas"),
            icon: Calendar,
          },
        ];
      ...
      case "admin":
        return [
          ...baseLinks,
          {
            ...
            label: getTranslation("navigation.adminPanel", "Painel Admin"),
            icon: Shield,
          },
          {
            href: `/${currentLocale}/admin/users`,
            label: getTranslation("navigation.users", "Utilizadores"),
            icon: Users,
          },
          {
            href: `/${currentLocale}/admin/tours`,
            label: getTranslation("navigation.allTours", "Todos os Tours"),
            icon: MapPin,
          },
        ];
